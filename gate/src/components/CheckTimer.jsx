...
import { setToValue, addValue } from "../utils/Slices/SliceTimer";
...
export default function CheckTimer() {
    ...
    return ( 
        ...
        <Box style={timerSliderBox}>
            <Typography variant="h3" margin={"5rem"} textAlign={"center"}> Per quanto vuoi <br/> rimanere concentrato? </Typography>
            <Typography fontSize={"3rem"}> {formatTime(timer)} </Typography>
